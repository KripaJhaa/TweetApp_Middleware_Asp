...
namespace ApiRequest.Controllers
{
    public class AccountController : ApiController
    {
        ...
        //Code Checkikng Tweets with Like By User

        [AllowCrossSiteJson]
        [Route("api/Account/newgetAllTweet")]
        [HttpPost]
        public IHttpActionResult NewGetAllTweet([FromBody] User userObj)
        {
            IList<TweetWithLike> ListOfTweet = userBusinessLogic.NewGetAllTweets(userObj);
            if (ListOfTweet == null)
            {
                return NotFound();
            }
